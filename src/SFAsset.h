 ...
 */
enum SFASSETTYPE { SFASSET_DEAD, SFASSET_PLAYER, SFASSET_PROJECTILE, SFASSET_WEBBING, SFASSET_ALIEN, SFASSET_COIN, SFASSET_WALL, SFASSET_DAM_WALL, SFASSET_DOOR, SFASSET_BUILDER };
